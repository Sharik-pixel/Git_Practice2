...
public class Array_Practice1 {
    ...
    public static void main(String[] args) {
       //  String students = "Alla", "Muhtar", "Alla";

        String[] students = {"Cybertek", "Muhtar", "Nadir", "Asya", "Saim"};
        //                      0            1        2       3        4

        String name1 = students[4];
        String name2 = students[2];
        String name3 = students[3];
        String name4 = students[4];
        ...
        //              0    1   2   3    4
        String [] names = {"Mike", "Adam","Tonny", "Amy","John"}; // size: 5
        //                   0        1      2       3      4
